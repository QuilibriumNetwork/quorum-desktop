...
export const ModalTestScreen: React.FC = () => {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.surface[0], padding: 20 }}>
      <Text style={{ color: colors.text.strong, fontSize: 24, fontWeight: 'bold', marginBottom: 10 }}>
        Modal Primitive
      </Text>
      <Text style={{ color: colors.text.subtle, fontSize: 16, marginBottom: 30 }}>
        Cross-platform modal that transforms to drawer on mobile
      </Text>

      <View style={{ marginBottom: 30 }}>
        <Text style={{ color: colors.text.strong, fontSize: 18, fontWeight: 'bold', marginBottom: 15 }}>
          Basic Modal
        </Text>
        
        <TouchableOpacity style={buttonStyle} onPress={() => setBasicModal(true)}>
      ...
      <View style={{ marginBottom: 30 }}>
        ...
        <TouchableOpacity style={buttonStyle} onPress={() => setSmallModal(true)}>
          <Text style={buttonText}>Small Modal (40% height)</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={buttonStyle} onPress={() => setMediumModal(true)}>
          <Text style={buttonText}>Medium Modal (70% height)</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={buttonStyle} onPress={() => setLargeModal(true)}>
          <Text style={buttonText}>Large Modal (90% height)</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={buttonStyle} onPress={() => setFullModal(true)}>
      ...
      <View style={{ marginBottom: 30 }}>
        ...
        <TouchableOpacity style={buttonStyle} onPress={() => setNoCloseModal(true)}>
          <Text style={buttonText}>No Close Button</Text>
        </TouchableOpacity>
        
        <TouchableOpacity style={buttonStyle} onPress={() => setNoSwipeModal(true)}>
      ...
      >
        <View style={{ padding: 20 }}>
          <Text style={{ color: colors.text.main, fontSize: 16, marginBottom: 16, lineHeight: 24 }}>
      ...
      >
        <View style={{ padding: 20 }}>
          <Text style={{ color: colors.text.main, fontSize: 16, marginBottom: 16 }}>
            This is a medium modal that takes up 70% of the screen height. This is the default size.
          </Text>
          <View style={{ backgroundColor: colors.surface[3], padding: 16, borderRadius: 8, marginBottom: 16 }}>
            <Text style={{ color: colors.utilities.warning, fontSize: 14, marginBottom: 8 }}>
              📱 Swipe Gesture Test
            </Text>
            <Text style={{ color: colors.text.subtle, fontSize: 12, lineHeight: 18 }}>
              Try swiping down from the top handle area to close this modal. 
              The gesture only works from the handle and header area.
            </Text>
          </View>
          <TouchableOpacity 
      ...
      >
        <ScrollView style={{ padding: 20 }}>
          ...
          <Text style={{ color: '#ccc', fontSize: 14, marginBottom: 16, lineHeight: 20 }}>
            Large modals are perfect for complex forms or detailed content that needs more space.
            Notice how the content area is scrollable if it exceeds the available height.
          </Text>
          <View style={{ backgroundColor: '#1E3A8A', padding: 16, borderRadius: 8, marginBottom: 16 }}>
            <Text style={{ color: 'white', fontSize: 16, fontWeight: 'bold', marginBottom: 8 }}>
              Scrollable Content
            </Text>
            <Text style={{ color: '#E5E7EB', fontSize: 14, lineHeight: 20 }}>
              This content demonstrates that the modal content area is scrollable when it exceeds 
              the available height. You can scroll through long content while maintaining the 
              header and swipe-to-close functionality.
            </Text>
          </View>
          <TouchableOpacity 
      ...
      >
        <View style={{ padding: 20, flex: 1 }}>
          ...
          <Text style={{ color: '#ccc', fontSize: 14, marginBottom: 16, lineHeight: 20 }}>
            Full-screen modals remove the rounded corners and extend to the full height. 
            Perfect for immersive experiences or complex workflows.
          </Text>
      ...
      >
        <View style={{ padding: 20 }}>
          <Text style={{ color: 'white', fontSize: 16, marginBottom: 16 }}>
            This modal has no close button in the header. You can still close it by:
          </Text>
      ...
      >
        <View style={{ padding: 20 }}>
          <Text style={{ color: colors.text.main, fontSize: 16, marginBottom: 16 }}>
            This modal has swipe-to-close disabled. Notice there's no handle at the top.
            You can only close it by:
          </Text>
          <Text style={{ color: colors.text.subtle, fontSize: 14, marginBottom: 8 }}>
            • Tapping the ✕ button
          </Text>
      ...
      <Modal
        title={currentPage === 'menu' ? 'Settings' : currentPage === 'profile' ? 'Profile Settings' : 'Appearance'}
      ...
      >
        <View style={{ flex: 1 }}>
          {currentPage === 'menu' ? (
            <View style={{ padding: 20 }}>
              <Text style={{ color: colors.text.main, fontSize: 16, marginBottom: 20 }}>
                This demonstrates navigation within a modal, similar to UserSettingsModal on desktop.
              </Text>
              
              <TouchableOpacity 
                style={[buttonStyle, { backgroundColor: colors.surface[3], marginBottom: 12 }]} 
                onPress={() => setCurrentPage('profile')}
              >
                <Text style={[buttonText, { color: colors.text.main }]}>Profile Settings →</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={[buttonText, { color: colors.text.main }]}>Appearance →</Text>
              </TouchableOpacity>
              ...
              >
                <Text style={[buttonText, { color: colors.text.main }]}>Close Settings</Text>
              </TouchableOpacity>
            </View>
          ) : currentPage === 'profile' ? (
            <View style={{ padding: 20 }}>
              ...
              >
                <Text style={{ color: colors.accent[500], fontSize: 16 }}>← Back to Settings</Text>
              </TouchableOpacity>
              
              <Text style={{ color: colors.text.strong, fontSize: 18, marginBottom: 16 }}>
                Profile Settings
              </Text>
              <Text style={{ color: colors.text.main, fontSize: 14, lineHeight: 20 }}>
                Configure your profile, username, avatar, and other personal settings here.
              </Text>
            </View>
          ) : (
            <View style={{ padding: 20 }}>
      ...
      <View style={{ backgroundColor: colors.surface[2], padding: 15, borderRadius: 8, marginBottom: 20 }}>
        <Text style={{ color: colors.utilities.success, fontSize: 14, fontWeight: 'bold', marginBottom: 8 }}>
          📱 Mobile Testing Notes
        </Text>
        <Text style={{ color: colors.text.subtle, fontSize: 12, lineHeight: 18 }}>
          • Web: Centered modal with backdrop and ESC key support{'\n'}
          • Mobile: Bottom drawer with slide-up animation and swipe gestures{'\n'}
          • All sizes adapt to mobile screen dimensions (40%, 70%, 90%, 100%){'\n'}
          • Swipe gestures work from handle and header area only{'\n'}
          • Theme-aware colors adapt to light/dark mode automatically{'\n'}
          • No FontAwesome dependencies - uses simple ✕ character
        </Text>
      </View>
    </ScrollView>
  );
