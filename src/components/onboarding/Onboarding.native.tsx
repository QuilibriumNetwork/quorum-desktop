  ...
  const getStepNumber = (step: string) => {
    switch (step) {
      ...
      case 'profile-photo':
        return 3;
      case 'complete':
        return 3; // Complete step shows step 3 as done
      default:
        return 1;
    }
  };
                ...
                <FlexRow justify="center">
                  ...
                  >
                    <FlexColumn gap="md" align="center">
                      ...
                      <Button
                        type={
                          !onboardingFlow.canProceedWithName
                            ? 'disabled-onboarding'
                            : 'primary-white'
                        }
                      ...
                      >
                        ...
                        >
                          <Image
                            ...
                            source={{
                              uri:
                                getImageDataUrl() || DefaultImages.UNKNOWN_USER,
                            }}
                            contentFit="cover"
                          />
                  ...
                  >
                    <FlexColumn gap="md" align="center">
                      ...
                      <Button
                        ...
                        fullWidthWithMargin
                        onClick={() =>
                          onboardingFlow.completeOnboarding(setUser)
                        }
                      >
                        {t`Let's gooooooooo`}
                      </Button>
