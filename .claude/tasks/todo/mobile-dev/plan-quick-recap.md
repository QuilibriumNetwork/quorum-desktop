...
- :hourglass_flowing_sand: **Full components audit** - Audit via json/fontend-dashboard of all components to keep track of the work in Phase 1 (classify components as shared vs platform-specific)
- :hourglass_flowing_sand: **Web migration in progress** - Converting existing web components to use new primitives
- [ ] Extract business logic from complex components into shared hooks
