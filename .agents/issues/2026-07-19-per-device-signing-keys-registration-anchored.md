...
related:
  ...
  - .agents/issues/.done/2026-07-19-update-profile-inbox-poisoning-control-msg-impersonation.md (why in-band rebinding is banned)
  - .agents/docs/cryptographic-architecture.md ("Inbox Key Rotation" section — carries the interim note)
  - .agents/issues/.open/2026-01-09-space-owner-privacy-limitation.md (#111 — owner unverifiable by design)
---
...
2. **Bound `announce-keys` flooding per member** — but NOT with an evict-oldest
   ...
   `.agents/issues/.open/2026-07-20-announce-keys-flooding-unbounded-admissions.md`.
...
- Announce-keys accumulate in the mobile hub log and replay on every connect →
  ...
  only. Ref `.agents/issues/.open/2026-07-20-announce-keys-flooding-unbounded-admissions.md`.
- Multiple device registrations accrue per account across resets/re-logins. Ref
  `.agents/issues/.done/2026-07-21-device-registration-ghost-accumulation-cross-platform.md`.
