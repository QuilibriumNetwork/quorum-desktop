...
related: issues/transport/index.md
---
...
[`issues/.done/2026-07-29-session-replacement-strands-in-flight-frames.md`](../.done/2026-07-29-session-replacement-strands-in-flight-frames.md) — **read §7 first**, the original write-up was wrong on its central claim.
...
Reported in `issues/transport/2026-07-27-headless-space-harness.md`; code in
