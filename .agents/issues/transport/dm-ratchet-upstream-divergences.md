...
`.agents/issues/.done/2026-07-02-dm-message-delivery-unreliable-master.md`.
...
3. Optional hardening, desktop and mobile: dedupe-before-decrypt cache (redelivered frames
   ...
   `.agents/issues/.deferred/2026-07-17-dm-dedupe-before-decrypt.md`), folding session reset
   (`deleteEncryptionStates`) under the same lock, and automatic resend on missing delivery
   receipts (`.agents/issues/transport/2026-07-17-dm-dead-session-autoheal.md` — the highest-value
...
> `.agents/issues/transport/2026-07-26-dm-desktop-to-desktop-resurfaced.md`.
