...
IMPORTANT: there are still many elements that need to be switched to using our primitives (button,select,textarea,input): see .agents/issues/mobile-dev/.archived/primitive-migration-audit.md

#### Step 4: Modal Component Replacement

Detailed plan: .agents/tasks/todo/mobile-dev/modal-migration-plan.md
