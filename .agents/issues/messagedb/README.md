...
> **Sibling workstreams in flight (2026-05-19):** [quorum-shared migration](../quorum-shared-migration/README.md) and [test suite review](../.done/2026-05-19-test-suite-review.md). The receipts PR in the shared migration is coupled to Tier 0 #3 here (see [shared-migration-cross-check.md](./shared-migration-cross-check.md)).
