...
1. **PR-set 1: ✅ SHIPPED 2026-05-28.** `useTwoStepConfirm` extracted to shared (`2.1.0-18`); desktop's `useUserKicking` + `useSpaceLeaving` refactored to consume it. Mobile keeps inlined version for now. See [`../2026-05-28-migrate-use-two-step-confirm.md`](../.done/2026-05-28-migrate-use-two-step-confirm.md).
