...
- (Pre-existing, unrelated bug logged: UserSettingsModal shows stale display name without refresh — see `.agents/issues/.open/2026-05-30-user-settings-modal-stale-display-name.md`. NOT caused by this refactor; channel-message rendering reflects the new value correctly.)
