...
related:
  - ".agents/issues/.open/2026-08-10-identity-resolution-architecture-design.md (THE DESIGN — read first)"
...
- [ ] **Step 1: Read the design.** `.agents/issues/.open/2026-08-10-identity-resolution-architecture-design.md`, in particular constraint 2. Do not resolve a detached surface with the global ladder.
