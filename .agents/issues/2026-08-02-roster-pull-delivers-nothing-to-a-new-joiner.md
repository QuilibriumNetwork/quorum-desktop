...
`.agents/issues/transport/2026-08-01-desktop-send-retention-gap.md` before
...
`.agents/issues/transport/2026-07-27-headless-space-harness.md` is a written spec,
...
- This is not identity-specific — it is the documented transport gap surfacing
  ...
  `.agents/issues/transport/README.md` before designing anything here: the right
...
- `.agents/docs/features/identity-resolution-and-profile-sync.md` describes the
  ...
  currently do it.
- `.agents/issues/port-from-mobile/candidates.md` #32 reasons about deleting this
