...
### Project Context
- **MessageDB refactoring state**: `.agents/tasks/messagedb/messagedb-current-state.md`
- **Cross-platform architecture**: `.agents/issues/mobile-dev/docs/component-architecture-workflow-explained.md`
- **Lazy loading patterns**: `.agents/issues/.done/lazy-loading-implementation.md`
- **Feature analysis report**: `.agents/tasks/ANALYSIS_search-performance-optimization.md`
- **Executive summary**: `.agents/tasks/SUMMARY_search-performance-analysis.md`
