...
related:
  ...
  - .agents/issues/.done/2026-06-07-mention-type-filter-not-synced.md
deferred_followups:
...
| Bug #2: mention-type filter not synced cross-device | [`.agents/issues/.done/2026-06-07-mention-type-filter-not-synced.md`](2026-06-07-mention-type-filter-not-synced.md) | Sync bug, not a UX rename. Can ship independently. |
