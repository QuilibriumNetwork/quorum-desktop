...
6. **.agents/issues/.done/rehype-raw-security-fix-recap-2025-11-07.md** (this file)
...
- Original task: `.agents/tasks/remove-rehype-raw-security-fix.md`
- Security analysis: `.agents/issues/.done/security-analysis-message-markdown-renderer-2025-11-07.md`
