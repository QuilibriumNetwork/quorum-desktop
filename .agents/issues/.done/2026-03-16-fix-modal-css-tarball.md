---
type: task
title: "Fix Modal CSS for Tarball/npm Install"
status: done
created: 2026-03-16
---
...
Change status to `resolved` in `.agents/issues/.done/2026-03-16-quorum-shared-pre-built-dist-modal-broken.md`.

- [ ] **Step 3: Update migration prep task**

Mark step 8 (npm pack test) as unblocked in `.agents/issues/quorum-shared-migration/.done/2026-03-15-primitives-migration-prep.md`.
