---
type: task
title: "Old Onboarding Cleanup & Maintenance Restyling - Implementation Plan"
status: done
created: 2026-04-14
---
...
- [x] **Step 2: Remove re-export from barrel file**
...
- [x] **Step 1: Restyle Maintenance.tsx**
...
- [x] **Step 2: Update ErrorBoundary fallback in App.tsx**
...
- [x] **Step 1: Remove btn-disabled-onboarding and all white button variant classes**
...
- [x] **Step 1: Remove white variants from playground**
...
- [x] **Step 2: Remove white variant test cases**
...
- [x] **Step 0: Create branch from master (see above)**
...
- [x] **Step 1: Link or update quorum-shared**
