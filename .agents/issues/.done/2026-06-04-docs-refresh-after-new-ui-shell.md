---
type: task
title: "Docs refresh after new-UI shell migration"
status: done
created: 2026-06-04
---
...
- `.agents/issues/.done/2026-01-07-channel-ordering-feature.md` — line refs into deleted `NavMenu.tsx` and `SpaceButton.tsx`. Replace with analogous lines in `SpacesSidebar.tsx` / `SpacesSidebarRow.tsx`, or note "this pattern moved to <file>". Don't rewrite the task; just refresh its references so it stays usable.
