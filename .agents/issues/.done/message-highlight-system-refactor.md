...
- `.agents/issues/.done/message-highlight-system-optimization.md` - Original implementation docs
- `.agents/issues/.done/mention-highlight-60s-duration.md` - 60s mention duration research
