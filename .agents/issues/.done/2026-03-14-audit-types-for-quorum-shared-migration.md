...
related_tasks:
  - "issues/.done/2026-03-14-migrate-thread-types-to-quorum-shared.md"
  - "issues/.done/quorum-shared-space-tags.md"
  - "tasks/new-member-badge-spaces.md"
  - "issues/.done/primitives-migration-to-quorum-shared.md"
---
...
- **Thread types** — `issues/.done/2026-03-14-migrate-thread-types-to-quorum-shared.md`
- **Space Tags types** — `issues/.done/quorum-shared-space-tags.md`
...
4. **Consolidate with existing tasks** — Cross-reference findings against the already-audited items:
   - Thread types (from `issues/.done/2026-03-14-migrate-thread-types-to-quorum-shared.md`)
   - Space tag types (from `issues/.done/quorum-shared-space-tags.md`)
