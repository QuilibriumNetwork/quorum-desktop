---
type: task
title: "Device Naming Implementation Plan"
status: done
created: 2026-04-08
---
...
**Spec:** `.agents/issues/.done/2026-04-08-device-naming-design.md`
...
**Context:** Provides a suggested auto-detected name when the user opens the rename field for the first time. The detection logic is already documented in `.agents/issues/.done/device-identification-improvement.md` — port it as-is, keeping only what's needed for name generation.
...
describe('truncateAddress', () => {
  ...
  it('truncates a long address to first4...last4', async () => {
    ...
    expect(truncateAddress('QmPeerDEgVKpYZKYuFu2J49zHXnA8vZtEqHMtpB4imzzzz')).toBe('QmSX...73Jz');
  });
