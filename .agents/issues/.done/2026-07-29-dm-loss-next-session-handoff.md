...
⚠️ `issues/.done/2026-07-29-session-replacement-strands-in-flight-frames.md` — code
...
- **A received 0/20, zero warnings; B's own desktop got 20/20 — filed under a
  ...
  `issues/transport/2026-07-29-stale-returning-device-dm-sends-vanish-and-misfile.md`.
...
- Everything after this file: `issues/transport/2026-07-29-transport-debug-workflow-and-tooling.md`
