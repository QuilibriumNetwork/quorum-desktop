...
related_tasks:
  - .agents/issues/.open/2025-01-20-user-status.md
---
...
- Custom status / "Away" / "Do Not Disturb" — separate Presence feature (see `.agents/issues/.open/2025-01-20-user-status.md`).
