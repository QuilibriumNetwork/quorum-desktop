...
Plain-language plan first, then rewritten in document register for broader audience. Extracted to its own task doc at `.agents/issues/.done/2026-05-24-virtuoso-application-owned-scroll-anchoring.md` to keep the bug doc focused on diagnosis.
