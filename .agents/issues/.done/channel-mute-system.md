...
- **Context menu dependency**: Requires unified `ContextMenu` component from `.agents/issues/.done/dm-conversation-context-menu.md`
...
- [ ] Review `.agents/issues/.done/dm-conversation-context-menu.md` for ContextMenu component API
- [ ] Complete `.agents/issues/.done/dm-conversation-context-menu.md` task (ContextMenu component must exist)
