...
related:
  ...
  - ".agents/issues/.done/2026-07-28-dm-receive-holds-ratchet-lock-across-http.md (a different defect in the same handler)"
...
- No GC is proposed. `issues/.open/2025-12-09-encryption-state-evals-bloat.md` records ~16MB
