...
- [`.agents/issues/.done/2025-08-03-joinspacemodal-invalid-json-network-error.md`](2025-08-03-joinspacemodal-invalid-json-network-error.md): misattributed to "network issues"; real cause is the response-shape mismatch in Bug 1 above.
