...
created: 2026-05-24
updated: 2026-07-21
related_bug: 2026-05-24-virtuoso-measurement-scroll-reset.md
...
Note: the related bug doc [`2026-05-24-virtuoso-measurement-scroll-reset.md`](2026-05-24-virtuoso-measurement-scroll-reset.md) references a threads-panel follow-up (Session 22) that is tracked separately there, not part of this task.

## Context

This task implements the fix for the scroll-jank bug class documented in [`issues/.done/2026-05-24-virtuoso-measurement-scroll-reset.md`](2026-05-24-virtuoso-measurement-scroll-reset.md). Read that document first for the full diagnostic history (16 sessions, two confirmed bug classes B1 and B2, six β iterations).
