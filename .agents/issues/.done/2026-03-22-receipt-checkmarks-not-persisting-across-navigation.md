...
- `.agents/issues/.done/2026-03-19-standalone-delivery-ack-unreliable.md` — related issue with standalone acks not reaching sender
- `.agents/issues/.done/2026-03-18-dm-delivery-receipts-plan.md` — original delivery receipts implementation plan
- `.agents/issues/.done/2026-03-22-dm-read-receipts-plan.md` — read receipts implementation plan
