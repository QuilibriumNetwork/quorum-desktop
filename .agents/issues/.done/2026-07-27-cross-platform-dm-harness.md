...
related:
  - .agents/issues/.done/2026-07-27-headless-dm-harness.md (the desktop harness this extends — read FIRST)
  - .agents/issues/transport/2026-07-26-dm-desktop-to-desktop-resurfaced.md (the investigation)
...
Corroborated by `.agents/issues/.done/2026-07-27-combined-receipt-ack-and-protocol-options.md`,
...
- 2026-07-29: **slice 4 landed and measured — task complete.** Desktop PR #271 adds
  ...
  `issues/.done/2026-07-29-dm-loss-next-session-handoff.md`. The `dm-conversation-mix`
