...
- **DM bottom spacing** is tighter than Channel because PR #153's composer-overlay treatment was scoped to Channel only. DM's last message sits closer to the composer; a small browser bounce-back is visible when overscrolling at the bottom. Separate from snap logic — being addressed in Session 19 by applying the same overlay treatment to DM.
