...
- [Record and show what the last config publish did](issues/.open/2026-08-08-record-and-show-what-the-last-config-publish-actually-did.md) — no longer blocked: shared published, and the mobile half landed 2026-08-17 on `feat/config-sync-slice1-2` with 19 tests, each mutation-checked. Release-build verification is the remaining gap, and it is the whole point of the slice.
