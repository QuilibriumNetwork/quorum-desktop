...
See [security.md](../security.md) ("Control-Message Authorization (verified signer)") and [.agents/issues/.open/2026-06-25-MASTER-RECAP-control-message-auth.md](../../../issues/.open/2026-06-25-MASTER-RECAP-control-message-auth.md) for the full security rationale.
