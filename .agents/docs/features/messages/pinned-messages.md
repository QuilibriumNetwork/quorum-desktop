...
- [Pinned Messages Feature Plan](../../../issues/.done/pinned-messages-feature.md) - Original feature implementation
- [Pinned Messages Sync Task](../../../issues/.done/pinned-messages-sync.md) - Cross-client synchronization (✅ COMPLETED 2025-12-12)
