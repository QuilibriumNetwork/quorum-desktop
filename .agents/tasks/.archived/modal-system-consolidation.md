...
2. Update `.agents/docs/features/modals.md` to reference RouteWrapper
3. Add comment in Router.web.tsx explaining RouteWrapper usage
4. Update this task to "DONE"

**Documentation Updates**:

Add to `.agents/docs/features/modals.md`:
```markdown
## Router Integration
...
- [ ] Update .agents/docs/features/modals.md
...
- `.agents/docs/features/modals.md` - Modal system documentation
- `.agents/bugs/.solved/SOLVED_modal-navmenu-zindex-stacking.md` - Z-index issue history
