...
1. **Candidate selected** from [candidates.md](candidates.md). Confirm feature still doesn't exist on desktop (grep desktop for obvious symbols).
...
*Last updated: 2026-06-01 — folder created.*
