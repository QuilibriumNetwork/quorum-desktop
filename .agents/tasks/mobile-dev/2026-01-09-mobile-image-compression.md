...
## Objective
Implement the same client-side image compression system on the React Native/mobile side of the app to match the web implementation (see .agents\tasks\.done\client-side-image-processing.md), ensuring consistent behavior and user experience across platforms.
