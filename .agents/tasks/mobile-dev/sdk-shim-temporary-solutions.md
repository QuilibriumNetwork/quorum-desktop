...
- SDK Integration Issue: `.agents/tasks/todo/mobile-sdk-integration-issue.md`
- Cross-Platform Hooks Plan: `.agents/tasks/todo/mobile-dev/cross-platform-hooks-refactoring-plan.md`
- Component Architecture: `.agents/tasks/todo/mobile-dev/docs/component-architecture-workflow-explained.md`
