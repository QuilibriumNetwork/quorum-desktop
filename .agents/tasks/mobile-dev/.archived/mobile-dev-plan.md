...
IMPORTANT: there are still many elements that need to be switched to using our primitives (button,select,textarea,input): see .agents/tasks/todo/mobile-dev/primitive-migration-audit.md
