...
- **Cross-platform architecture**: `.agents/tasks/mobile-dev/docs/component-architecture-workflow-explained.md`
- **Lazy loading patterns**: `.agents/tasks/.done/lazy-loading-implementation.md`
