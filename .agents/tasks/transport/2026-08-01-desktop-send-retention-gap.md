...
status: OPEN — verified in code 2026-08-01, not previously tracked anywhere. Low urgency (desktop rarely hits the trigger), low effort, and it removes a whole failure class rather than mitigating one. The protection is MISSING, not unnecessary — what keeps desktop safe today is a property of Chromium's networking, not a decision anyone made
created: 2026-08-01
...
related:
  ...
  - ".agents/tasks/transport/2026-07-30-mobile-frames-lost-into-a-dying-websocket.md (the root cause this protects against)"
  - ".agents/tasks/.done/2026-07-31-ship-send-retention-to-quorum-shared.md (the fix mobile got)"
  - ".agents/tasks/transport/2026-07-17-dm-dead-session-autoheal.md (its heal action 1 is the alternative recovery route for desktop; this is the cheaper one)"
---
