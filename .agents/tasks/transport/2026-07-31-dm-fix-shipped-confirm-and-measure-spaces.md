...
status: OPEN — the DM work is done and published. Two device rounds remain, both operator-assisted. Nothing here is blocked on code
created: 2026-07-31
...
> `tasks/2026-07-31-spaces-list-cross-device-sync.md`, dated the same day. That one is about **which
