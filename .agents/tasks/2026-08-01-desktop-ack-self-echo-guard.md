...
status: open — needs a multi-device desktop run before it is called either a bug or a non-issue
created: 2026-08-01
priority: low
...
related:
  - "tasks/.done/2026-07-27-combined-receipt-ack-and-protocol-options.md (§8 R4 and §9 item 3, where this was found and spun out from)"
