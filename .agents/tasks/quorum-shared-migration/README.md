...
| Hooks (276 hook files) | Logic | 🟢 1 hook shipped (`useTwoStepConfirm`). Audit refreshed 2026-05-28. Future per-candidate tasks at `2026-XX-XX-migrate-<hook>.md` as scoped. | [designs/2026-05-28-hooks-audit-refresh.md](designs/2026-05-28-hooks-audit-refresh.md) |
