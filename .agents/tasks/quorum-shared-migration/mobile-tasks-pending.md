...
|---|---|---|---|---|---|
| 2026-05-28 | [`2026-05-28-adopt-shared-validators.md`](file:///D:/GitHub/Quilibrium/quorum-mobile/.agents/tasks/quorum-shared-migration/2026-05-28-adopt-shared-validators.md) | Drop mobile's local `validateSpaceName` + inline length constants in `SpaceModal.tsx` and `SpaceSettingsModal.tsx`; consume `@quilibrium/quorum-shared@2.1.0-19` validators via a thin English-string translator. Adds XSS check on space name (defense-in-depth). | quorum-desktop TBD (validation hooks migration) | ✅ required | 📋 open |
